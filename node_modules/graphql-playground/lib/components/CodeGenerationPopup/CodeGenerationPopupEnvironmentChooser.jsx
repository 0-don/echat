...
var Chooser = function (props) {
    return <div className={cx(graphcool_styles_1.$p.bt, graphcool_styles_1.$p.bb, graphcool_styles_1.$p.bBlack10, graphcool_styles_1.$p.flex1)}>
    ...
    <div className={cx(graphcool_styles_1.$p.pa38, graphcool_styles_1.$p.pt16, graphcool_styles_1.$p.flex, graphcool_styles_1.$p.flexColumn, graphcool_styles_1.$p.itemsCenter)}>
      <h2 className={cx(graphcool_styles_1.$p.fw3, graphcool_styles_1.$p.mb10, graphcool_styles_1.$p.tc)}>Environment</h2>
      <div className={cx(graphcool_styles_1.$p.dib, graphcool_styles_1.$p.mt25)}>
        ...
        return (<div className={cx(graphcool_styles_1.$p.relative, graphcool_styles_1.$p.flex, graphcool_styles_1.$p.itemsCenter, graphcool_styles_1.$p.justifyCenter, graphcool_styles_1.$p.pointer)} onClick={function () { return props.setEnvironment(env); }} style={{ width: width + 15 }} key={env}>
            ...
            _a[cx(graphcool_styles_1.$p.pv6, graphcool_styles_1.$p.bgBlack04)] = props.environment !== env,
            _a[cx(graphcool_styles_1.$p.bgGreen, graphcool_styles_1.$p.br2, graphcool_styles_1.$p.pv8, graphcool_styles_1.$p.z1)] = props.environment === env,
            _a))}>
                  <div className={cx(graphcool_styles_1.$p.ttu, graphcool_styles_1.$p.fw6, graphcool_styles_1.$p.f14, (_b = {},
            _b[graphcool_styles_1.$p.black30] = props.environment !== env,
            _b[graphcool_styles_1.$p.white] = props.environment === env,
            _b))}>
                    {env}
                  </div>
                </div>
