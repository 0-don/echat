...
var MiddlewareApp = /** @class */function (_super) {
    ...
    function MiddlewareApp(props) {
        ...
        var configIsYaml = props.configString ? _this.isConfigYaml(props.configString) : false;
        var _a = _this.getInitialActiveEnv(props.config),
        ...
        _this.state = {
            ...
            subscriptionEndpoint: subscriptionEndpoint ? _this.normalizeSubscriptionUrl(endpoint, subscriptionEndpoint) : '',
    ...
    MiddlewareApp.prototype.migrateSettingsString = function (settingsString) {
        ...
        try {
            ...
            var settings = __assign({}, defaultSettingsObject, lodash_1.mapKeys(currentSettings, function (value, key) {
    ...
    MiddlewareApp.prototype.componentWillReceiveProps = function (nextProps) {
        if (nextProps.configString !== this.props.configString && nextProps.configString) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    { theme: __assign({}, styled_1.theme, { mode: theme }) },
                    React.createElement(
