...
var ExecuteButtonOperation = /** @class */function (_super) {
    ...
    ExecuteButtonOperation.prototype.render = function () {
        ...
        return React.createElement(
            "li",
            { key: operation.name ? operation.name.value : '*', className: operation === highlight ? 'selected' : '', onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut, onMouseUp: this.handleMouseUp },
