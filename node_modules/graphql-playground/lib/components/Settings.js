    ...
    Settings.prototype.render = function () {
        return React.createElement(
            ...
            React.createElement(
                IconWrapper,
                null,
                React.createElement(Icon_1.default, { src: require('graphcool-styles/icons/fill/settings.svg'), width: 23, height: 23, onClick: this.props.onClick, className: 'settings-icon' })
            )
        );
    };
    return Settings;
