...
export class ServiceMigration1629914970959 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    INSERT INTO service(name, slug, type, popularity, "boxArtUrl")
    VALUES
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
    DELETE FROM service WHERE type IN ('Interactive Entertainment');
    DELETE FROM service WHERE type IN ('More Lifestyles');
    `);
  }
}
